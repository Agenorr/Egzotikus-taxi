...
const categories = [
  { name: "All", label: "Összes autó", images: ["https://i0.wp.com/www.hesol.co.in/wp-content/uploads/2020/12/AUTOMOTIVE.jpg?fit=1500%2C938&ssl=1"] },
  { name: "Sedan", label: "Sedan", images: ["https://www.auto-data.net/images/f66/Bentley-Flying-Spur-IV.jpg", "https://www.auto-data.net/images/f42/Mercedes-Benz-E-class-W214.jpg", "https://www.auto-data.net/images/f109/Genesis-G80-II-facelift-2023.jpg"] },
  { name: "Coupe", label: "Coupe", images: ["https://www.auto-data.net/images/f87/BMW-M2-G87.jpg", "https://www.auto-data.net/images/f56/Lamborghini-Revuelto_2.jpg", "https://www.auto-data.net/images/f55/Porsche-911-992-facelift-2024.jpg"] },
  { name: "Hatchback", label: "Hatchback", images: ["https://www.auto-data.net/images/f107/Volkswagen-Golf-VIII_2.jpg", "https://www.auto-data.net/images/f46/Honda-Civic-Type-R-FL5.jpg", "https://www.auto-data.net/images/f33/Acura-Integra-V_2.jpg"] },
  { name: "Crossover", label: "Crossover", images: ["https://www.auto-data.net/images/f5/file9888950.jpg", "https://www.auto-data.net/images/f35/Renault-Koleos-II-Phase-II.jpg", "https://www.auto-data.net/images/f115/Subaru-Ascent-facelift-2023.jpg"] },
  { name: "SUV", label: "SUV", images: ["https://www.auto-data.net/images/f17/lamborghini-urus.jpg", "https://www.auto-data.net/images/f85/BMW-X7-G07-facelift-2022_4.jpg", "https://www.auto-data.net/images/f110/Cadillac-Escalade-IQ.jpg"] },
  { name: "Luxury", label: "Luxury", images: ["https://www.auto-data.net/images/f100/Rolls-Royce-Phantom-VIII-Extended-Wheelbase.jpg", "https://www.auto-data.net/images/f73/Bugatti-La-Voiture-Noire.jpg", "https://www.auto-data.net/images/f77/Mercedes-Benz-S-class-Long-V223-facelift-2026.jpg"] },
  { name: "Pickup", label: "Pickup", images: ["https://www.auto-data.net/images/f126/Ford-Ranger-V-SuperCrew-Americas_2.jpg", "https://www.auto-data.net/images/f33/Jeep-Gladiator-JT-facelift-2023_4.jpg", "https://www.auto-data.net/images/f38/Chevrolet-Silverado-3500-HD-IV-T1XX-facelift-2024-Crew-Cab-Long-Bed.jpg"] },
  { name: "Wagon", label: "Wagon", images: ["https://www.auto-data.net/images/f99/Skoda-Superb-IV.jpg", "https://www.auto-data.net/images/f80/Volkswagen-Passat-Variant-B9.jpg", "https://www.auto-data.net/images/f49/Audi-RS6-Avant-C8.jpg"] },
  { name: "Minivan", label: "Minivan", images: ["https://www.auto-data.net/images/f86/Mercedes-Benz-V-class-Long-facelift-2019_2.jpg", "https://www.auto-data.net/images/f58/Volkswagen-ID.Buzz-Long.jpg", "https://www.auto-data.net/images/f99/Lexus-LM-II.jpg"] }
];
...
export default function CarRental() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      document.querySelectorAll(".bg-img.next").forEach(el => el.classList.add("fade-in"));
      setTimeout(() => {
        setImageIndexes(prev => prev.map((idx, i) => (idx + 1) % categories[i].images.length));
        document.querySelectorAll(".bg-img").forEach(el => el.classList.remove("fade-in", "fade-out"));
      }, 500);
    }, 10000);
  ...
  const handleCategoryClick = async (categoryName) => {
    ...
    const params = categoryName === "All" ? {} : { category: categoryName };
      ...
      <div className={`flex-grow-1 d-flex flex-column page-transition ${isFading ? 'page-hidden' : ''}`}>
        ...
        <section className="carrental-hero w-100">
          <div className="carrental-hero-content">
            ...
            <p className="carrental-hero-sub">Találja meg az Ön számára tökéletes luxusautót kínálatunkban.</p>
          </div>
        </section>
            ...
            <div className="row w-100 mx-0">
              {categories.map((cat, i) => (
                <div
                  ...
                  key={cat.name}
                  style={{ height: "250px", borderRadius: "0.5rem", cursor: "pointer", border: "1px solid #333" }}
                  onClick={() => handleCategoryClick(cat.name)}
                >
                  <div className="bg-fader">
                    <div className="bg-img current" style={{ backgroundImage: `url(${cat.images[imageIndexes[i]]})` }} />
                    <div className="bg-img next" style={{ backgroundImage: `url(${cat.images[(imageIndexes[i] + 1) % cat.images.length]})` }} />
                  </div>
                  <div style={{ position: "absolute", inset: 0, backgroundColor: "rgba(0,0,0,0.6)", borderRadius: "0.5rem" }} />
                ...
                <div style={{
                  ...
                  <div className="filter-panel-custom p-4 shadow-lg">
                    ...
                    <div className="mb-4">
                      ...
                      {['Benzin', 'Dízel', 'Hibrid', 'Elektromos'].map(fuel => (
                        <div className="form-check d-flex align-items-center mb-2" key={fuel}>
                          <input className="form-check-input white-checkbox me-2" type="checkbox" id={`fuel-${fuel}`}
                            checked={selectedFuel.includes(fuel)} onChange={() => toggleFilter(selectedFuel, setSelectedFuel, fuel)} />
                          <label className="form-check-label text-white small" htmlFor={`fuel-${fuel}`}>{fuel}</label>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="text-center mb-4 mt-3">
                      <button className="btn btn-link text-decoration-none shadow-none toggle-btn-text p-0 no-focus-ring"
                        onClick={() => setShowAdvancedFilters(!showAdvancedFilters)}>
                        {showAdvancedFilters ? "▲ Kevesebb szűrő" : "▼ További szűrők"}
                      </button>
                    </div>

                    <button className="btn w-100 clear-btn-outline no-focus-ring" onClick={handleClearFilters}>Szűrés törlése</button>
                  </div>
                </div>
              </div>
                        ...
                        <div className="col-12 col-md-6 col-xl-4" key={car.id}>
                          ...
                          >
                            ...
                            <div className="card-content position-absolute bottom-0 start-50 translate-middle-x w-100 text-center pb-4" style={{ zIndex: 2 }}>
                              ...
                              <h5 className="mb-4" style={{ textShadow: "2px 2px 10px rgba(0,0,0,1), -1px -1px 4px rgba(0,0,0,0.8)", fontWeight: "300", color: "#e0e0e0" }}>
                                {car.model}
                              </h5>
                            </div>
